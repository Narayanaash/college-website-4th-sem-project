<?php
    ...
    if(isset($_POST['display'])){
     $query="SELECT * FROM personalchat WHERE room= '$roomName' OR room= '$roomName2' ";
     $result=mysqli_query($conn,$query);
        
     $query2="SELECT id FROM personalchat WHERE room= '$roomName' OR room= '$roomName2' ORDER BY id DESC LIMIT 1";
